...
def efficientnet(model_name='efficientnet-b0', pretrained=True, num_classes=4, **kwargs):
    """
    ...
    model = func(model_name=model_name, num_classes=num_classes)
    return model
...
#     net = efficientnet( pretrained=True,  num_classes=4).cuda()
#     y_class = net(torch.randn(4, 3, 1024, 1024).cuda())
#     print(y_class.size())
