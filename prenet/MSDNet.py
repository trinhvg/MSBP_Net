...
def msdnet(pretrained=False, nr_class= 4):
    ...
    if pretrained:
        ...
        pre_trained_path = '/media/data1/trinh/code/SBP_project/SBP_PCAM/ResNet/code/models/step4/msdnet-step=4-block=5.pth.tar'
        ...
        # pretrained_model = torch.load('/media/data1/trinh/code/pretrained_model/res2net50_26w_4s-06e79181.pth')
    return model
#
# def _test():
#     import os
#     os.environ['CUDA_VISIBLE_DEVICES'] = '3'
#     # net = ASPP(in_channels=3, atrous_rates=[12, 24, 36], nr_class=4).cuda()
#     net = msdnet(pretrained=True, nr_class=3).cuda()
#     output = net(torch.randn(4, 3, 1024, 1024).cuda())
#     #
...
#     #     prec1, prec5 = accuracy(output[j].data, target=torch.Tensor([1, 2, 3, 0]), topk=(1, 2))
#
#
#     print(output[0].size())
