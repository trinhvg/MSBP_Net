...
"""
Source: https://github.com/linzhi123/deep-persion-reid
"""
...
class ConvLayers(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = ConvBlock(3, 96, k=7, s=2, p=3)
...
class MuDeep(nn.Module):
    ...
    def __init__(self, num_classes, fc_in=5, loss={'xent'}, **kwargs):
        ...
        self.fc = nn.Sequential(
            nn.Linear(256 * fc_in * fc_in, 4096),
            nn.BatchNorm1d(4096),
            nn.ReLU(),
        )
...
#     images = torch.rand(4, 3, 1024, 1024).cuda(0)
#     # model = res2net101_26w_4s(pretrained=True)
#     model = MuDeep(num_classes=3, fc_in=32)
#     # model = MuDeep(num_classes=4, fc_in=6)
#     model = model.cuda(0)
