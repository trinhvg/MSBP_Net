...
"""
Source: https://github.com/Res2Net/Res2Net-ImageNet-Training
"""
...
def res2net50(pretrained=False, num_classes=4, **kwargs):
...
#     model = res2net50(pretrained=True, num_classes=4)
#     model = model.cuda(0)
